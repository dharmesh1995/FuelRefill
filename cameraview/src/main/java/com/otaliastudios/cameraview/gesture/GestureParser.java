...
public class GestureParser {
    ...
    private int swipeUpActioon;
    private int swipedownActioon;
    ...
    public GestureParser(@NonNull TypedArray array) {
        ...
        this.swipeUpActioon = array.getInteger(R.styleable.CameraView_cameraGestureScrollVertical, GestureAction.DEFAULT_SWIPE_UP.value());
        this.swipedownActioon = array.getInteger(R.styleable.CameraView_cameraGestureScrollVertical, GestureAction.DEFAULT_SWIPE_DOWN.value());
    }
    ...
    public GestureAction getswipeupAction() {
        return get(swipeUpActioon);
    }

    public GestureAction getswipedownAction() {
        return get(swipedownActioon);
    }
